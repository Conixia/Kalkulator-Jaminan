...
# ── Page config ────────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Kalkulator Surety Bond Jamkrindo Purwokerto",
    page_icon="🏦",
    layout="centered",
)
...
jamkrindo_logo = get_base64_image("jamkrindo.png")
danantara_logo = get_base64_image("danantara-indonesia-seeklogo.png")
...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px; padding-top:4px;">
    <img src="data:image/png;base64,{jamkrindo_logo}" style="height:48px; object-fit:contain;">
    <img src="data:image/png;base64,{danantara_logo}" style="height:40px; object-fit:contain;">
</div>

<div class="hero-title">Kalkulator <span>Jaminan</span></div>
<div class="hero-sub">Penawaran · Pelaksanaan · Uang Muka · Pemeliharaan — Minimum Rp 75.000</div>
''', unsafe_allow_html=True)
